...
| Attendance | references, class registers, learner marks, submission, reasoned reopen | Agent reads are live; mutations require approval and exact current versions. |
