...
| Attendance | assigned class registers, learner marks and history, submission, reasoned reopen | Agent reads are live and record-scoped; mutations require approval and exact current versions. |
