...
| E-learning | class spaces, units, governed resources, assignments, quizzes, attempts, feedback, progress, completion | Agent receives scoped metadata and derived completion only; learner projections omit answer keys, and private file bytes and downloads remain human-only. |
