...
- Academics owns academic years, terms, canonical tenant-wide grade levels, subjects, classes, employee-backed teacher profiles, and teaching assignments. A class belongs to an academic year and references a canonical grade level by identifier; the display label is never copied into the class record. Academic terms are contained by their year, cannot overlap, move only forward through planned, active, and closed states, and keep their year/code/date boundary after activation. SIS owns learner enrolment and class placement. Academics entitlements include HR and payroll because teacher identity is resolved from the employee directory.
...
- Academics is authoritative for the active academic year and term, canonical grade levels, classes, subjects, employee-backed teachers, and teaching assignments. SIS applications and staged imports resolve grade references through Academics; Timetabling rehydrates academic records through typed Academics operations and never accepts client copies as authoritative.
