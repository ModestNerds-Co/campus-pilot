...
- Academics owns academic years, terms, subjects, classes, employee-backed teacher profiles, and teaching assignments. Academic terms are contained by their year, cannot overlap, move only forward through planned, active, and closed states, and keep their year/code/date boundary after activation. SIS owns learner enrolment and class placement. Academics entitlements include HR and payroll because teacher identity is resolved from the employee directory.
...
- Applications and enrolments reference Academics-owned academic years and classes by stable campus-scoped identifiers. SIS does not copy class or academic-year records, and an enrolment cannot be moved to another learner after creation.
...
- Academics is authoritative for the active academic year, classes, subjects, employee-backed teachers, and teaching assignments. Timetabling rehydrates those records through typed Academics operations and never accepts client copies as authoritative.
