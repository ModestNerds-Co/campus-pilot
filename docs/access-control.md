...
- Academics is authoritative for the active academic year and term, canonical grade levels, classes, subjects, employee-backed teachers, teaching assignments, assessment structures, and Gradebook lifecycle. SIS applications and staged imports resolve grade references through Academics; Timetabling, Attendance, and Gradebook rehydrate academic records through typed owning-module operations and never accept client copies as authoritative. Assessment components resolve class, subject, and teacher through their teaching assignment. Attendance and Gradebook consume SIS enrolments through a typed owning-module boundary.
