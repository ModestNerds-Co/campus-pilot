...
- Academics is authoritative for the active academic year and term, canonical grade levels, classes, subjects, employee-backed teachers, teaching assignments, and assessment structures. SIS applications and staged imports resolve grade references through Academics; Timetabling and Attendance rehydrate academic records through typed Academics operations and never accept client copies as authoritative. Assessment components resolve class, subject, and teacher through their teaching assignment. Attendance consumes SIS enrolments through a typed owning-module boundary.
