...
- Academics owns academic years, subjects, classes, employee-backed teacher profiles, and teaching assignments. Academics entitlements include HR and payroll because teacher identity is resolved from the employee directory.
