...
export type ReviewStatus = "pending" | "approved" | "rejected" | "deletion_pending" | "executed";
...
export interface LegalHold{id:string;file_id:string;file_reference:string;file_title:string;reference:string|null;reason:string;status:"active"|"released";version:number;applied_by:string;applied_at:string;released_by:string|null;released_at:string|null;release_reason:string|null;created_at:string;updated_at:string}
...
export interface LegalHoldsResponse{legal_holds:LegalHold[]}
