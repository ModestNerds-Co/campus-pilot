...
export interface InboxItem { delivery_id: string; announcement_id: string; title: string; body: string; priority: AnnouncementPriority; sender_name: string; published_at: string; read_at: string | null }
