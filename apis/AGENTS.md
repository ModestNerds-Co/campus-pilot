...
- Academics owns academic years, non-overlapping academic terms, subjects, classes, employee-backed teacher profiles, and teaching assignments. Terms remain inside their academic year and move forward through planned, active, and closed states. Timetabling consumes Academics records through typed `cp-academics` operations and owns only schedule rules, rooms, unavailability, room preferences, generated snapshots, and publication state. SIS remains the source of learner enrolment and class placement.
