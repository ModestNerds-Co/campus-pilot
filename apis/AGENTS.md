...
- Academics owns academic years, subjects, classes, employee-backed teacher profiles, and teaching assignments. Timetabling consumes those records through typed `cp-academics` operations and owns only schedule rules, rooms, unavailability, room preferences, generated snapshots, and publication state.
