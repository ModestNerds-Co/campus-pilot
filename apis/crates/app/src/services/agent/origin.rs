...
const ACTIVITIES: OriginAccess = OriginAccess::module("activities", "activities:view");
...
const EXACT_ROUTES: &[ExactRoute] = &[
    ...
    ExactRoute {
        path: "/modules/activities/groups",
        access: ACTIVITIES,
    },
    ExactRoute {
        path: "/modules/activities/sessions",
        access: ACTIVITIES,
    },
    ExactRoute {
        path: "/modules/activities/catalog",
        access: ACTIVITIES,
    },
    ExactRoute {
        path: "/modules/hostel",
